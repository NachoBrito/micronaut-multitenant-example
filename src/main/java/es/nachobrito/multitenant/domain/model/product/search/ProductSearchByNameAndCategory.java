 ...
 * @author nacho
 */
public record ProductSearchByNameAndCategory(String name, CategoryId category)
  ...
  public ProductSearch withMerchant(MerchantId merchantId) {
    return new MerchantProductSearchByNameAndCategory(merchantId, this.name, this.category);
  }
}
